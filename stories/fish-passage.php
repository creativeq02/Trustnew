...
<div class="container-fluid no-padding white-color" style="background: url(../images/fish-bg.jpg); background-position: center; background-size: cover;">
...
<div class="container tb-small">
  ...
  <div class="row">
    <div class="col-md-6 animatable fadeInLeft">
      <h1 class="mb-4 mt-3">Fish Passage</h1>
    ...
    <div class="col-md-6 animatable fadeInUp text-center pl-5 pr-5 mt-4">
       <img src="../images/fish-mechiene.png">
